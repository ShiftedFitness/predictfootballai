...
const SCOPES = [
  ...
  { id: 'club_arsenal',     label: 'Arsenal',          type: 'club', clubName: 'Arsenal',              clubId: 4  },
  { id: 'club_astonvilla',  label: 'Aston Villa',      type: 'club', clubName: 'Aston Villa',          clubId: 13 },
  { id: 'club_blackburn',   label: 'Blackburn',        type: 'club', clubName: 'Blackburn Rovers',     clubId: 9  },
  { id: 'club_bolton',      label: 'Bolton',           type: 'club', clubName: 'Bolton Wanderers',     clubId: 27 },
  { id: 'club_bournemouth', label: 'Bournemouth',      type: 'club', clubName: 'Bournemouth',          clubId: 47 },
  { id: 'club_brentford',   label: 'Brentford',        type: 'club', clubName: 'Brentford',            clubId: 50 },
  { id: 'club_brighton',    label: 'Brighton',         type: 'club', clubName: 'Brighton',              clubId: 48 },
  { id: 'club_burnley',     label: 'Burnley',          type: 'club', clubName: 'Burnley',              clubId: 43 },
  { id: 'club_charlton',    label: 'Charlton',         type: 'club', clubName: 'Charlton Athletic',    clubId: 31 },
  { id: 'club_chelsea',     label: 'Chelsea',          type: 'club', clubName: 'Chelsea',              clubId: 7  },
  { id: 'club_coventry',    label: 'Coventry',         type: 'club', clubName: 'Coventry City',        clubId: 12 },
  { id: 'club_crystalpalace', label: 'Crystal Palace', type: 'club', clubName: 'Crystal Palace',       clubId: 11  },
  { id: 'club_derby',       label: 'Derby',            type: 'club', clubName: 'Derby County',         clubId: 29 },
  { id: 'club_everton',     label: 'Everton',          type: 'club', clubName: 'Everton',              clubId: 1  },
  { id: 'club_fulham',      label: 'Fulham',           type: 'club', clubName: 'Fulham',               clubId: 34 },
  { id: 'club_ipswich',     label: 'Ipswich',          type: 'club', clubName: 'Ipswich Town',         clubId: 14 },
  { id: 'club_leeds',       label: 'Leeds',            type: 'club', clubName: 'Leeds United',         clubId: 18 },
  { id: 'club_leicester',   label: 'Leicester',        type: 'club', clubName: 'Leicester City',       clubId: 26  },
  { id: 'club_liverpool',   label: 'Liverpool',        type: 'club', clubName: 'Liverpool',            clubId: 17  },
  { id: 'club_mancity',     label: 'Man City',         type: 'club', clubName: 'Manchester City',      clubId: 21 },
  { id: 'club_manutd',      label: 'Man Utd',          type: 'club', clubName: 'Manchester Utd',       clubId: 20 },
  { id: 'club_middlesbrough', label: 'Middlesbrough',  type: 'club', clubName: 'Middlesbrough',        clubId: 22 },
  { id: 'club_newcastle',   label: 'Newcastle',        type: 'club', clubName: 'Newcastle United',     clubId: 25 },
  { id: 'club_norwich',     label: 'Norwich',          type: 'club', clubName: 'Norwich City',         clubId: 19 },
  { id: 'club_nottmforest', label: 'Nottm Forest',     type: 'club', clubName: 'Nottingham Forest',    clubId: 15 },
  { id: 'club_portsmouth',  label: 'Portsmouth',       type: 'club', clubName: 'Portsmouth',           clubId: 37 },
  { id: 'club_qpr',         label: 'QPR',              type: 'club', clubName: 'Queens Park Rangers',  clubId: 5 },
  { id: 'club_reading',     label: 'Reading',          type: 'club', clubName: 'Reading',              clubId: 40 },
  { id: 'club_sheffutd',    label: 'Sheff Utd',        type: 'club', clubName: 'Sheffield United',     clubId: 16 },
  { id: 'club_sheffwed',    label: 'Sheff Wed',        type: 'club', clubName: 'Sheffield Weds',       clubId: 8 },
  { id: 'club_southampton', label: 'Southampton',      type: 'club', clubName: 'Southampton',          clubId: 2 },
  { id: 'club_stoke',       label: 'Stoke',            type: 'club', clubName: 'Stoke City',           clubId: 42 },
  { id: 'club_sunderland',  label: 'Sunderland',       type: 'club', clubName: 'Sunderland',           clubId: 28  },
  { id: 'club_swansea',     label: 'Swansea',          type: 'club', clubName: 'Swansea City',         clubId: 45 },
  { id: 'club_tottenham',   label: 'Spurs',            type: 'club', clubName: 'Tottenham Hotspur',    clubId: 6 },
  { id: 'club_watford',     label: 'Watford',          type: 'club', clubName: 'Watford',              clubId: 32  },
  { id: 'club_westbrom',    label: 'West Brom',        type: 'club', clubName: 'West Bromwich Albion', clubId: 35   },
  { id: 'club_westham',     label: 'West Ham',         type: 'club', clubName: 'West Ham United',      clubId: 24 },
  { id: 'club_wigan',       label: 'Wigan',            type: 'club', clubName: 'Wigan Athletic',       clubId: 39 },
  { id: 'club_wimbledon',   label: 'Wimbledon',        type: 'club', clubName: 'Wimbledon',            clubId: 10 },
  { id: 'club_wolves',      label: 'Wolves',           type: 'club', clubName: 'Wolves',               clubId: 38 },
];
